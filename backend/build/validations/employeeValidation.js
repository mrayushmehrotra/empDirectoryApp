...
exports.formatZodError = exports.idSchema = exports.updateEmployeeSchema = exports.createEmployeeInputSchema = exports.employeeSchema = exports.departmentSchema = void 0;
...
exports.employeeSchema = zod_1.z.object({
    ...
    department: zod_1.z.enum(["Sales", "Marketing", "Engineering"]),
...
exports.updateEmployeeSchema = zod_1.z.object({
    ...
    department: zod_1.z.enum(["Sales", "Marketing", "Engineering"]).optional(),
    floor: zod_1.z.number().int().min(1).max(100).optional()
});
// ID validation
